...
## Strategy Visualization
Below is the real-time strategy map generated by the SOM. Green areas represent high-expectancy trade setups, while red areas indicate high risk.

![Strategy Map](./images/strategy_map.png)

*The contours represent data density, helping the bot prioritize well-tested market states.*
